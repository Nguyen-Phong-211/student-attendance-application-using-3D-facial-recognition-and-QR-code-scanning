CREATE TABLE "face_recognition_logs" (
	"face_recognition_log_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "accounts" (
	"account_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "students" (
	"student_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "permissions" (
	"permission_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "departments" (
	"department_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "classes" (
	"class_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "schedules" (
	"schedule_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "rooms" (
	"room_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "attendance" (
	...
	"student_id" BIGINT NOT NULL,
	"attendance_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"status" CHAR(1) NOT NULL,
...
CREATE TABLE "leave_requests" (
	"leave_request_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"student_id" BIGINT NOT NULL,
...
CREATE TABLE "reminders" (
	"reminder_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "subjects" (
	"subject_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "academic_years" (
	"academic_year_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "notifications" (
	"notification_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"title" VARCHAR(255) NOT NULL,
	"content" TEXT NOT NULL,
...
CREATE TABLE "devices" (
	"device_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"student_id" BIGINT NOT NULL,
...
CREATE TABLE "students_subjects" (
	"students_subject_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"subject_id" BIGINT NOT NULL,
	"student_id" BIGINT NOT NULL,
...
CREATE TABLE "lecturers" (
	"lecturer_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "lecturer_subjects" (
	"lecturer_subject_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"subject_id" BIGINT NOT NULL,
...
CREATE TABLE "audit_logs" (
	"log_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "class_students" (
	"class_student_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"class_id" BIGINT NOT NULL,
	"student_id" BIGINT NOT NULL,
	"created_at" TIMESTAMP NOT NULL,
...
CREATE TABLE "majors" (
	"department_id" BIGINT NOT NULL,
	"major_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "semesters" (
	"semester_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "qr_checkin" (
	"qr_checkin_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "subject_registration_requests" (
	"subject_registration_request_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"student_id" BIGINT NOT NULL,
	"subject_id" BIGINT NOT NULL,
	"semester_id" BIGINT NOT NULL,
	"reason" TEXT,
...
CREATE TABLE "attendance_verifications" (
	"verification_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "credit_limits" (
	"credit_limit_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"student_id" BIGINT NOT NULL,
	"semester_id" BIGINT NOT NULL,
	"min_credits" INTEGER,
...
CREATE TABLE "staffs" (
	"staff_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
	"fullname" VARCHAR(255) NOT NULL,
	"account_id" BIGINT NOT NULL,
	"department_id" BIGINT NOT NULL,
	"gender" CHAR(1) NOT NULL,
...
CREATE TABLE "import_logs" (
	"import_log_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE "shifts" (
	"shift_id" BIGINT NOT NULL UNIQUE AUTO_INCREMENT,
